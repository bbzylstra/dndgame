def characterCreate(screen):
    ...
    while running:
        ...
        GraphicInput.display_message(screen,'hp = '+str(hp),(0,(z)*1))
        GraphicInput.display_message(screen,'mana = '+str(mana),(0,((z)*2)))
        GraphicInput.display_message(screen,'stamina = '+str(stamina),(0,((z)*3)))
        GraphicInput.display_message(screen,'strength = '+str(stre),(0,((z)*4)))
        GraphicInput.display_message(screen,'agility = '+str(agl),(0,((z))*5))
        GraphicInput.display_message(screen,'intelligence = '+str(inte),(0,(z)*6))
        GraphicInput.display_message(screen,'courage = '+str(cour),(0,((z)*7)))
        GraphicInput.display_message(screen,'dexterity = '+str(dex),(0,((z)*8)))
        GraphicInput.display_message(screen,'concentration = '+str(conc),(0,(z)*9))
        GraphicInput.display_message(screen,'race = '+race,(0,(z)*10))
        GraphicInput.display_message(screen,'class = '+cclass,(0,(z)*11))
    pathname = os.path.abspath(os.getcwd()+"/saves/%s/" % name)
