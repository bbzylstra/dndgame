    ...
    while running:
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_ESCAPE:
                break
        GraphicInput.display_box(screen,'name ='+name,(0,0))
        GraphicInput.display_box(screen,'hp ='+str(hp),(0,50))
        GraphicInput.display_box(screen,'mana ='+str(mana),(0,100))
        GraphicInput.display_box(screen,'stamina ='+str(stamina),(0,150))
        GraphicInput.display_box(screen,'strength ='+str(stre),(0,200))
        GraphicInput.display_box(screen,'agility ='+str(agl),(0,250))
        GraphicInput.display_box(screen,'intelligence ='+str(inte),(0,300))
        GraphicInput.display_box(screen,'courage ='+str(cour),(0,350))
        GraphicInput.display_box(screen,'dexterity ='+str(dex),(0,400))
        GraphicInput.display_box(screen,'concentration ='+str(conc),(0,450))
